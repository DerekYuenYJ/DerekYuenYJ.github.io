...
title: 'Theme 1: Atmosphere and Climate'
...
**Theme 1: Atmosphere and Climate** will be the subject of learning until the Week 3 lecture session. To better aid with your learning, please refer to this recommended learning flow:

During **Week 1 IS**, you will be introduced to the chapter and we will discuss the contents of sections 1-4. ***Prior to the session***, read through sections 1-4 and attempt exercise questions 1-4 while referring to the model answers provided. If you have any queries, you may bring them up for discussion during the IS session. Familiarize yourself with Figures 5 and 6 as well.

During **Week 2 lecture**, we will be discussing the contents of sections 5-7. We will also be focusing on modelling the temperature evolution model and discussing the ice-albedo model. ***Prior to the session***, ensure you have completed modelling questions M1 - M4 after Week 1's IS and read through sections 5-7. 

During **Week 2 IS** and **Week 3 lecture** sessions, we will be discussing the models you've done so far and your analysis of the models. You may continue to work on your models during this session and discuss with your peers if you face challenges in coding. If you have any questions on the contents taught, you may reach out to the lecturer and your mentors to seek clarification as well.
...
-   Define what climate change is and why action against climate change is critical for the sustainability of life.
...
#### 1.2 BACKGROUND
##### (A) The role of Earth's atmosphere
...
![**Figure 2.** Evidence of a changing climate. Adapted from NASA: Global Climate Change](Media\Figure2.png "Figure 2: Evidence of a changing climate. Adapted from NASA: Global Climate Change"){width="100%"}
...
<p style='text-align: justify;'>Under the push for global collaboration on sustainable development, the United Nations (UN) adopted 17 Sustainable Development Goals (SDG). **Goal 13: Climate action** primarily aims to:
...
3.  Emphasize education and develop institutional capacities on climate change resilience, adaptability, impact reduction and early warning.</p>

#### 1.3 PURPOSE OF MODELLING
...
![](Media\Table1.png){fig-align="center" width="100%"}

## 3 |  SIMPLE RADIATIVE EQUILIBRIUM WITH NO ATMOSPHERE
...
![**Figure 3.** Incoming solar radiation (left) and outgoing Earth radiation (right)](Media\Figure3.png){fig-align="center" width="80%"}  
...
![**Figure 4:** (Left) Blackbody emission spectra of an object with increasing temperature (3000K to 6000K). (Right) Blackbody emission spectra of the Sun and the Earth](Media\Figure4.png){fig-align="center" width="100%"}  
...
![**Figure 5:** Illustration of energy dispersion through the inverse square law.](Media\Figure5.jpg "Figure 5: Illustration of energy dispersion through the inverse square law."){width="80%"}  
...
![](Media\Table2.png){fig-align="center" width="50%"}  

#### 3.3 EFFECTIVE TEMPERATURE OF A PLANET
...
![**Figure 6:** The effective surface areas of incoming solar flux and the planet flux](Media\Figure6.png){fig-align="center" width="50%"}  
...
![**Figure 7:** Molecular vibrations of N<sub>2</sub>, O<sub>2</sub>, CO<sub>2</sub> and H<sub>2</sub>O. You can view the animations [here](https://scied.ucar.edu/learning-zone/atmosphere/molecular-vibration-modes).](Media\Figure7.png){fig-align="center" width="80%"}  
...
![**Figure 8:** The amount of greenhouse gas IR-absorption is shown in green and the Earth blackbody emitted radiation is shown in orange.](Media\Figure8.png){fig-align="center" width="60%"}
...
![**Figure 9:** **Left**, One-layer model: $F_s$, $F_g$ and $F_a$ are respectively the emission from the sun, the Earth's surface and the atmosphere (with $\tau_s$ = 0.8 and $\tau_g$ = 0.1). **Right**, The blackbody emission spectrum of the sun and measured solar radiation before and after going through the atmosphere.](Media\Figure9.png){fig-align="center" width="100%"}
...
## 5 | TEMPERATURE EVOLUTION MODEL
#### 5.1 EARTH AS A GREYBODY
...
#### 5.3 TEMPERATURE EVOLUTION MODEL
...
![](Media\Plot1.jpg){fig-align="center" width="80%"}
...
![](Media\FlowChart1.png){fig-align="center" width="100%"}
...
![**Figure 11:** Water vapor feedback.](Media\Figure11.png){fig-align="center" width="100%"} 

![**Figure 12:** The phase diagram of water.](Media\Figure12.png){fig-align="center" width="50%"}
...
![**Figure 13:** Ice-albedo feedback.](Media\Figure13.png){fig-align="center" width="100%"}  
...
![**Figure 14:** Ice-albedo model illustration when solar luminosity is decreasing.](Media\Icealbedo.gif){fig-align="center" width="100%"} 

#### 7.2 MODEL SET-UP
##### (A) Energy gain

![**Figure 15:** Distribution of the solar flux across latitudes.](Media\Figure14.png){fig-align="center" width="100%"}  
...
![](Media\Table5.png){fig-align="center" width="100%"} 
...
![](Media\FlowChart2.png){fig-align="center" width="100%"}
---
...
![**Figure 16:** Positive feedback loops of the Ice-albedo model](Media\Figure15.png){fig-align="center" width="100%"}
